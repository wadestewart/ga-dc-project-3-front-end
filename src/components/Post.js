        ...
        return (
            <div class="container">
                ...
                <form
                    ...
                    action="/movies"
                    method="post"
                    onSubmit={e => this.props.postSubmit(e, this.state)}
                >
                    <input
                        className="center"
                        type="text"
                    ...
                    <input
                        ...
                        name="yearInput"
                        placeholder="Year"
                        onChange={e => this.handleInput(e, 'yearInput')}
                    />
                    <input
                        className="center"
                        type="text"
                        ...
                        onChange={e => this.handleInput(e, 'providersInput')}
                    />
                    <input
                        className=" center btn waves-effect waves-light red accent-4"
                        type="submit"
                        value="Add Movie"
                    />
                </form>
